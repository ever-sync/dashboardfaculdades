...
DROP POLICY IF EXISTS "Users can view their own demographic metrics" ON metricas_demographicas;
DROP POLICY IF EXISTS "Users can insert their own demographic metrics" ON metricas_demographicas;
DROP POLICY IF EXISTS "Users can update their own demographic metrics" ON metricas_demographicas;
